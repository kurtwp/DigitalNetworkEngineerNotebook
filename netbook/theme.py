...
def apply_global_styles() -> None:
    ...
    <style>
      * {{ box-sizing: border-box; margin: 0; padding: 0; }}
      ...
      .q-dialog .q-card {{ display: flex !important; flex-direction: column !important; }}
      .q-dialog .q-card > * {{ display: flex !important; flex-direction: column !important; flex: 1 !important; }}
      .q-dialog .q-card .q-textarea {{ flex: 1 !important; display: flex !important; flex-direction: column !important; }}
      .q-dialog .q-card .q-textarea .q-field__control {{ flex: 1 !important; display: flex !important; flex-direction: column !important; }}
      .q-dialog .q-card .q-textarea .q-field__control .q-field__native {{ flex: 1 !important; }}
